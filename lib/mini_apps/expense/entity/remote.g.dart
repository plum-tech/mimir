...
DatapackRaw _$DatapackRawFromJson(Map<String, dynamic> json) => DatapackRaw()
  ...
  ..retdata = (json['retdata'] as List<dynamic>)
      .map((e) => TransactionRaw.fromJson(e as Map<String, dynamic>))
      .toList()
  ..retmsg = json['retmsg'] as String;

Map<String, dynamic> _$DatapackRawToJson(DatapackRaw instance) =>
    <String, dynamic>{
...
TransactionRaw _$TransactionRawFromJson(Map<String, dynamic> json) =>
    TransactionRaw()
...
Map<String, dynamic> _$TransactionRawToJson(TransactionRaw instance) =>
    <String, dynamic>{
