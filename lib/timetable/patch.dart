...
class BuiltinTimetablePatchSets {
  static final vacationShift2024 = BuiltinTimetablePatchSet(
    ...
    patches: [
      TimetableRemoveDayPatch.oneDay(loc: TimetableDayLoc.date(DateTime(2024, 1, 1))),
      TimetableRemoveDayPatch.oneDay(loc: TimetableDayLoc.date(DateTime(2024, 4, 4))),
      ...
      TimetableMoveDayPatch(
        source: TimetableDayLoc.date(DateTime(2024, 5, 3)),
        target: TimetableDayLoc.date(DateTime(2024, 4, 30)),
      ),
      TimetableMoveDayPatch(
      ...
      TimetableRemoveDayPatch.oneDay(loc: TimetableDayLoc.date(DateTime(2024, 5, 1))),
      TimetableRemoveDayPatch.oneDay(loc: TimetableDayLoc.date(DateTime(2024, 6, 10))),
      TimetableMoveDayPatch(
      ...
      TimetableRemoveDayPatch.oneDay(loc: TimetableDayLoc.date(DateTime(2024, 9, 17))),
      TimetableMoveDayPatch(
