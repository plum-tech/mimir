...
class _GameState extends ConsumerState<Game2048> with TickerProviderStateMixin, WidgetsBindingObserver , GameAbilityMixin {
  ...
  @override
  List<GameAbility> createAbility()  => [AutoSaveAbility(onSave: onSave)];
  @override
  void initState() {
    super.initState();
